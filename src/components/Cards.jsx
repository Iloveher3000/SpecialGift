            ...
            <motion.div
                ...
                {cardState === "mainQuestion" && (
                    <QuestionCard
                        key="main-question"
                        emoji="🥰"
                        question="EVEN THO I KNOW THE ANSWERR but still, Can you be mine forever?"
                        onAnswer={(answer) => {
                            if (answer) {
                ...
                {cardState === "areYouSure" && (
                    <QuestionCard
                        key="are-you-sure"
                        emoji="🙃"
                        question="How dare youu sayy noo"
                        onAnswer={(answer) => {
                ...
                {cardState === "finalNoResponse" && (
                    <QuestionCard
                        ...
                        emoji="🥺"
                        question="TU basss meriii HAII THEEK HAII NA, abb pyaar se wapas jaake yess likhh"
                        showButtons={false}
                        btnText="Go back"
