...
export default function SecretCodeCard({ onCorrect }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (code === 'Jannu') {
            ...
            setError("Hint: DUMBOO youuu cant guess thiss?, First letter is capital and it has double 'n' ")
    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                <h2 className="text-xl font-medium text-gradient mb-4 text-center relative z-10">I have Locked my heart and you have the key, enter the secret code to enter my heart(Enter the word I call you the most, first letter capital)</h2>
